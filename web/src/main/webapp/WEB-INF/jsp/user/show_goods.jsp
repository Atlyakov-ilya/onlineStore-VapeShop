...
<h1 class="centered">Все товары</h1>
                ...
                <div class="col-md-3 products">
                    <div class="product">
                        <div class="product-img">
                            <a href="/user/show_one_item/${goods.goodsId}"><img
                                    src="${pageContext.request.contextPath}/user/downloadGoodsFile/<c:out value="${goods.goodsId}"/>"
                                    alt="photo"></a>
                        </div>
...
<div class="centered">
    <a href="/user/show_goods/1">1</a>
    <a href="/user/show_goods/2">2</a>
    <a href="/user/show_goods/3">3</a>
</div>
