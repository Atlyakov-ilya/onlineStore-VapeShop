...
<h1 class="centered">Аккумуляторы</h1>
                ...
                <div class="col-md-3 products">
                    <div class="product">
                        <div class="product-img">
                            <a href="show_one_item/${goods.goodsId}"><img src="${pageContext.request.contextPath}/user/downloadGoodsFile/<c:out value="${goods.goodsId}"/>"
                                                                          alt="photo"></a>
                        </div>
